...
def process_inputs(audio_filepath,image_filepath):
    ...
    if image_filepath:
        ...
        doctor_response="NO image is provided for me to analyze"    

    voice_of_doctor=text_to_speech_with_elevenlabs(input_text=doctor_response,
...
iface=gr.Interface(fn=process_inputs,
                   inputs=[gr.Audio(sources=["microphone"],type="filepath"),
                    ...
                    outputs=[gr.Textbox(label="Speech to Text"),
                             ...
                             gr.Audio("Temp.mp3")],
                    title="MedAI with Vision and Voice")
